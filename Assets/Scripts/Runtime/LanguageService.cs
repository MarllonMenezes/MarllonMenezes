...
public sealed class LanguageService
{
    private readonly Dictionary<string, string> _pt = new()
    {
        ...
        ["item.pet.cat"] = "Gatinho", ["item.pet.dog"] = "Cachorrinho", ["item.pet.bow"] = "Laço", ["item.pet.cap"] = "Boné", ["item.pet.bandana"] = "Bandana",
    ...
    private readonly Dictionary<string, string> _en = new()
    {
        ...
        ["item.pet.cat"] = "Kitten", ["item.pet.dog"] = "Puppy", ["item.pet.bow"] = "Bow", ["item.pet.cap"] = "Cap", ["item.pet.bandana"] = "Bandana",
